...
if(isset($_POST['submit'])){
  ...
  $pass = $_POST['password'];
$sql = mysqli_query($conn,"SELECT * FROM bdo_org WHERE phone = '$phone_no' AND password = '$pass' ");
...
if (confirm("Login successful") == true) {
    window.location.href = "blood_transfusion.php";
}
else{
  window.location.href = "blood_transfusion.php";
}</script><?php
...
if (confirm("Incorrect login details. please try again") == true) {
    window.location.href = "bdo_login.php";
}
else{
  window.location.href = "bdo_login.php";
}</script><?php
                ...
                <div class="p-5">
                  ...
                  <form class="user" action="" method="POST">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="phone_no" aria-describedby="emailHelp" placeholder="Enter Phone no.." required>
                    </div>
                    <div class="form-group">
