...
package com.swahilibox.mobile.vision.qrcode.login.service;
...
import com.swahilibox.mobile.vision.qrcode.login.ui.activity.MainActivity;
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(mContext)) {
                ...
                if (TextUtils.isEmpty(imageUrl)) {
                    showNotificationMessage(mContext, title, message, timestamp, resultIntent);
                } else {
                    // image is present, show notification with image
                    showNotificationMessageWithBigImage(mContext, title, message, timestamp, resultIntent, imageUrl);
                }
            }
