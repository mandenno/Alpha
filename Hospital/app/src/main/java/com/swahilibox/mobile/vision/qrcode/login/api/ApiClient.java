package com.swahilibox.mobile.vision.qrcode.login.api;



import com.swahilibox.mobile.vision.qrcode.login.api.interceptor.AccessTokenInterceptor;
import com.swahilibox.mobile.vision.qrcode.login.api.interceptor.AuthInterceptor;
import com.swahilibox.mobile.vision.qrcode.login.api.services.STKPushService;
...
import static com.swahilibox.mobile.vision.qrcode.login.util.AppConstants.BASE_URL;
import static com.swahilibox.mobile.vision.qrcode.login.util.AppConstants.CONNECT_TIMEOUT;
import static com.swahilibox.mobile.vision.qrcode.login.util.AppConstants.READ_TIMEOUT;
import static com.swahilibox.mobile.vision.qrcode.login.util.AppConstants.WRITE_TIMEOUT;
