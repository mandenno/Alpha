...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, ContactsAdapterFavs.ContactsAdapterListener {
    ...
    private static final String URLTWO = "https://alpha.nupola.com/myinbox.php?phone=";
    @Override
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.hist) {
            ...
            Intent intent = new Intent(MainActivity.this, FQAs.class);
            startActivity(intent);
